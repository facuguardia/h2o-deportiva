            ...
            isMobile ? (
              ...
              <>
                ...
                <CardTestimonial
                  ...
                  text="¡El conjunto PowerMove es todo lo que esperaba y más! Me siento súper motivada cuando me lo pongo. La tela es suave y transpirable, ideal para mis clases de baile. El diseño es moderno y elegante. ¡Gracias, H2O Deportiva, por esta increíble oferta y por hacer que mi experiencia de compra sea tan satisfactoria!"
                />

                <CardTestimonial
                  image="/images/prof3.jpg"
                  name="ANA MARTÍNEZ"
                  text="¡Este sujetador es un verdadero salvavidas! Como una entusiasta del running, necesitaba algo que me brindara el soporte adecuado, y el Sujetador Endurance de H2O Deportiva lo hizo. Es cómodo, proporciona un ajuste perfecto y evita cualquier molestia durante mis carreras. ¡Gracias por pensar en nosotras siempre!"
                />
              </>
            )
          }
